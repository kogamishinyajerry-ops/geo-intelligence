...
from geo.recon.queries import SHANGHAI_QUERIES

_THEME = {q.text: q.theme for q in SHANGHAI_QUERIES}
_ORDER = {q.text: i for i, q in enumerate(SHANGHAI_QUERIES)}

# segment → 主要游客触点平台（客群分叉的结论：内容该铺在哪）
