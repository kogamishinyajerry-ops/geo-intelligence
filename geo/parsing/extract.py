...
def segment_watchlist_key(seg_value: str) -> str | None:
    """BuyerSegment.value → 该品类 watchlist 的段 key（随 active profile）。"""
    from geo.category import active_profile

    return active_profile().watchlist_keys.get(seg_value)
