...
from geo.recon.queries import GIFT_BOX_QUERIES

_THEME = {q.text: q.theme for q in GIFT_BOX_QUERIES}
_ORDER = {q.text: i for i, q in enumerate(GIFT_BOX_QUERIES)}

# segment → 该走货架（买家分叉的结论）
